...
public class KdTree implements Tree {
	 ...
	 */
	public static List<KdNode> allNodes;
	public static List<KdNode> leftSideNodes;
	public static List<KdNode> rightSideNodes;
	...
	public void randomNearestNeighbor(KdNode v, Point queryPoint, int k, KdResult result, String status) {
	...
	public KdResult randomNearestQuery(Point queryPoint, int k) {
		...
		KdNode startNode = findStartingNode(queryPoint, randomNode);
