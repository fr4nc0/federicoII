...
// constructor 1 - use user specified IC file
	public JWS(String dir, String wnvers, String icfile)
	{
		...
		wnhome 	=	dir + File.separator + wnvers +File.separator +"dict";
		icfilename	=	dir + File.separator + wnvers + File.separator+"WordNet-InfoContent-" + wnvers+ File.separator + icfile; // user defined IC file
...
// constructor 2 - use default SemCor IC file
	public JWS(String dir, String wnvers)
	{
		...
		wnhome 	=	dir + File.separator + wnvers +File.separator +"dict";//	wnhome 	=	 dir + "/" + wnvers + "/dict";
		icfilename	=	dir+File.separator + wnvers + File.separator+ "WordNet-InfoContent-"+ wnvers+ File.separator+"ic-semcor.dat";// dir + "/" + wnvers + "/WordNet-InfoContent-" + wnvers+ "/ic-semcor.dat"; // default [ic-semcor.dat] IC file
		if(!exists(wnhome) || !exists(icfilename))
		{
			System.out.println("your directory paths are wrong:\n" + wnhome + "\n" + icfilename);
			System.exit(1);
